...
<html>
	...
	<body>
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<div class="content">
							<div class="inner">
								<h1>Web Based Messaging</h1>
								<p>Connect with your friends and more.<br />
								Explore people</p>
							</div>
						</div>
						<nav>
					...
					<div id="main">
						...
						<!-- Intro -->
							...
							<form action="add_people.php" method="post">
							    ...
							    <input type="submit" value="ADD" class="btn btn-primary bt1" style="display: inline-block" name="submit">  
							    <br>
							    <?php?>
			
                              <?php
         $query="select *from addpeople order by id ASC";
         ...
         if(mysqli_num_rows($result)>0)
         {
             ...
             while($row=mysqli_fetch_array($result))
             {
                 ?><h3 ><?php echo $row['name']; ?></h3>
                     <input type="submit" class="btn btn-danger bt2" value="REMOVE" name="remove">
							       <br>
                 ...
                 ?>
                    ...
                    <h3 ><?php echo $row['name']; ?></h3>
                       <a href="#mayank">
                         ...
                         <input type="submit" class="btn btn-danger bt2" value="CHAT" name="chat">
                        </a>
							       <br>
                     </div>
        ...
        ?>
							...
							<article id="mayank">
                            <div class="chat form-control" style="height:200px; width:557px; background-color:#54545c;">
                               <br>
                               <br>
